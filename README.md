...
1. Clone the repository:
   git clone https://github.com/hend-elsayed-github/Real-Estate-ITI-GraduationProject.git
2. Open the solution file `Real-Estatae-GraduationProject.sln` in Visual Studio (or your IDE)
