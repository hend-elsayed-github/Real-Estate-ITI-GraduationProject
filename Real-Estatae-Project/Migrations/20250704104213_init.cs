        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    createAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    activationPeriod = table.Column<int>(type: "int", nullable: false),
                    userId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Maintenance_unitId = table.Column<int>(type: "int", nullable: true),
                    paymentDate = table.Column<DateOnly>(type: "date", nullable: true),
                    dueDate = table.Column<DateOnly>(type: "date", nullable: true),
                    Rent_status = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Rent_unitId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BillParent", x => x.id);
                    table.ForeignKey(
                        name: "FK_BillParent_Units_Maintenance_unitId",
                        column: x => x.Maintenance_unitId,
                        principalTable: "Units",
                        principalColumn: "id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_BillParent_Units_Rent_unitId",
                        column: x => x.Rent_unitId,
                        principalTable: "Units",
                        principalColumn: "id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_BillParent_Units_unitId",
                        column: x => x.unitId,
                        principalTable: "Units",
                        principalColumn: "id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillParent_Maintenance_unitId",
                table: "BillParent",
                column: "Maintenance_unitId");

            migrationBuilder.CreateIndex(
                name: "IX_BillParent_Rent_unitId",
                table: "BillParent",
                column: "Rent_unitId",
                unique: true,
