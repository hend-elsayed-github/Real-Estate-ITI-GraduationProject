...
namespace Real_Estatae_Project.Migrations
{
    ...
    [Migration("20250704105218_billId-issue")]
    partial class billIdissue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Real_Estatae_Project.Models.BillParent", b =>
                {
                    ...
                    b.ToTable("BillParent");

                    b.HasDiscriminator<string>("Discriminator").HasValue("BillParent");

                    b.UseTphMappingStrategy();
                });

            modelBuilder.Entity("Real_Estatae_Project.Models.BillPayment", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Real_Estate_Project.Models.VerificationCode", b =>
                {
                    ...
                    b.Property<int>("activationPeriod")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Real_Estate_Project.Models.Bill", b =>
                {
                    b.HasBaseType("Real_Estatae_Project.Models.BillParent");
            ...
            modelBuilder.Entity("Real_Estate_Project.Models.Maintenance", b =>
                {
                    ...
                    b.ToTable("BillParent", t =>
                        {
                            t.Property("unitId")
                                .HasColumnName("Maintenance_unitId");
                        });
            ...
            modelBuilder.Entity("Real_Estatae_Project.Models.BillPayment", b =>
                {
                    ...
                    b.HasOne("Real_Estate_Project.Models.Payment", "payment")
                        .WithMany()
